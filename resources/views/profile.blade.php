...
Sebagai salah satu sekolah Teknologi Informasi dan Komunikasi  bermutu di Depok, prestasi yang telah dicapai oleh SMK Taruna Bhakti Depok  ini memang sesuai dengn visi dan misi yang diembannya</p></div>
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><h3 class="mt-5">VISI SMK TARUNA BHAKTI</h3>
  <p class="mt-3">1. Menghasilkan lulusan yang kompeten dalam IPTEK DAN  IMTAQ,
<br>
2. serta mampu bersaing pada tingkat nasional dan global</p>
  <h3 class="mt-4">MISI SMK TARUNA BHAKTI</h3>
  <p class="mt-3">1. Menumbuhkan semangat kreatifitas, bersinergi dan kompetitif kepada seluruh warga sekolah <br>
...
5. Menerapkan layanan prima dalam pengelolaan sekolah melalui Sistem Manajeman Mutu</p>
  </div>
  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
    <h3 class="mt-4">TUJUAN SMK TARUNA BHAKTI</h3>
   <P class="mt-3"> 
    1. Menghasilkan lulusan yang kompeten <br>
2. Meningkatkan kualitas pembelajaran. <br>
3. Menyiapkan peserta didik agar mampu mengembangkan sikap profesional, mampu beradaptasi dan  berkompetisi <br>
4. Meningkatkan kepuasan masyarakat untuk memperoleh layanan pendidikan <br>
5. Konsistensi pelaksanaan aktifitas, kendali mutu dan jaminan mutu sekolah. <br>
6. Meningkatkan kesejahteraan warga sekolah. <br>
<br>
Dalam segala aktivitas Proses Pendidikan menerapkan budaya mutu sebagai berikut : <br>
<ul>
...
<li><b>Our quality ask be different</b></li></ul></P></div>
</div>
</div>

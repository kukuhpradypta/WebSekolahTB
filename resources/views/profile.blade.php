...
<nav class="nav nav-tabs flex-column flex-sm-row mt-1">
  <a class="flex-sm-fill text-sm-center nav-link fw-bold active " aria-current="page" data-bs-toggle="tab" data-bs-target="#home">Sejarah</a>
  <a class="flex-sm-fill text-sm-center nav-link fw-bold " data-bs-toggle="tab" data-bs-target="#profile">Visi dan Misi</a>
  <a class="flex-sm-fill text-sm-center nav-link fw-bold " data-bs-toggle="tab" data-bs-target="#contact">Tujuan SMK Taruna Bhakti</a>
</nav>
<div class="row mt-5">
  <div class="col-md-9">
  <div class="tab-content mb-5" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
     <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><h3 class=""><b>SEJARAH SMK TARUNA BHAKTI</b></h3>
      <br>
